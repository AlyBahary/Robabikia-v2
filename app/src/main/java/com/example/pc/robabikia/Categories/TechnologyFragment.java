...
/*progrssDialog intialization*/
        ...
        tdialog.setTitle("Techology");
        tdialog.show();
        RequestQueue requestQueue = Volley.newRequestQueue(getActivity());
        StringRequest stringRequest;
        stringRequest=new StringRequest(Request.Method.GET, Constants.Ur_+"technology"+Constants._l, new Response.Listener<String>() {
            @Override
