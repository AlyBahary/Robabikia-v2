...
/*progrssDialog intialization*/
        ...
        wdialog=new ProgressDialog(getActivity());
        wdialog.setMessage("Loading...");
        wdialog.setTitle("Weather");
        wdialog.show();
        RequestQueue requestQueue = Volley.newRequestQueue(getActivity());
        StringRequest stringRequest;
        stringRequest=new StringRequest(Request.Method.GET, Constants.Ur_+"weather"+Constants._l, new Response.Listener<String>() {
            @Override
